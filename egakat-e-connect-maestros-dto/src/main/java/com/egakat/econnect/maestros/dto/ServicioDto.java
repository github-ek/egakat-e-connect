...
@NoArgsConstructor
@AllArgsConstructor
public class ServicioDto extends BusinessEntityDto<Long> implements ObjectWithCode<Long>, SortableObject, InactivableObject {
	...
	@Builder
	public ServicioDto(Long id, int version, String creadoPor, LocalDateTime fechaCreacion, String modificadoPor,
