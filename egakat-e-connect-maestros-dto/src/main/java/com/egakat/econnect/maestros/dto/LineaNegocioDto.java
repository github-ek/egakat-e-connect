...
@NoArgsConstructor
@AllArgsConstructor
public class LineaNegocioDto extends BusinessEntityDto<Long>
	...
	@Builder
	public LineaNegocioDto(Long id, int version, String creadoPor, LocalDateTime fechaCreacion, String modificadoPor,
