...
@NoArgsConstructor
@AllArgsConstructor
public class UnidadNegocioDto extends BusinessEntityDto<Long> implements ObjectWithCode<Long>, SortableObject, InactivableObject {
	...
	@Builder
	public UnidadNegocioDto(Long id, int version, String creadoPor, LocalDateTime fechaCreacion, String modificadoPor,
