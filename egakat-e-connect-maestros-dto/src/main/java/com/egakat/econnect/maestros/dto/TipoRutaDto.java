...
@NoArgsConstructor
@AllArgsConstructor
public class TipoRutaDto extends BusinessEntityDto<Long> implements ObjectWithCode<Long>, SortableObject, InactivableObject {
	...
	@Builder
	public TipoRutaDto(Long id, int version, String creadoPor, LocalDateTime fechaCreacion, String modificadoPor,
