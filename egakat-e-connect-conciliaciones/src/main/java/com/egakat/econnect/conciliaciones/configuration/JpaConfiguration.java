package com.egakat.econnect.conciliaciones.configuration;
...
public class JpaConfiguration extends HikariConfig {
	...
	static final String PACKAGES_TO_SCAN_FOR_REPOSITORIES = "com.egakat.econnect.conciliaciones.repository";

	static final String[] PACKAGES_TO_SCAN_FOR_ENTITIES = { "com.egakat.econnect.conciliaciones.domain",
