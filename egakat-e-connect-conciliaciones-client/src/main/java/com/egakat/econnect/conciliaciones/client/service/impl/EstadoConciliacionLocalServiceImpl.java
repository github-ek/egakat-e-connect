...
import com.egakat.econnect.conciliaciones.client.components.ConciliacionesRestClient;
import com.egakat.econnect.conciliaciones.client.properties.ConciliacionesRestProperties;
...
public class EstadoConciliacionLocalServiceImpl extends LocalQueryServiceImpl<EstadoConciliacionDto, Long> implements EstadoConciliacionLocalService {
	...
	@Autowired
	private ConciliacionesRestClient restClient;
