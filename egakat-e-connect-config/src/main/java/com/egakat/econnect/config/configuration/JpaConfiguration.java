package com.egakat.econnect.config.configuration;
...
public class JpaConfiguration {
	...
	static final String PACKAGES_TO_SCAN_FOR_REPOSITORIES = "com.egakat.econnect.config.repository";

	static final String[] PACKAGES_TO_SCAN_FOR_ENTITIES = { "com.egakat.econnect.config.domain",
